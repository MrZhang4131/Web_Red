<template>
    <div class="man_note">
        ...
        <!-- 核心内容区 -->
        <div class="note_item" v-for="(item,index) in Notes_Data.records" :key="index">
           ...
           <div class="item_content">
                ...
                <div>
                  ...
                  <el-button type="primary" icon="el-icon-delete" plain @click="delete_noteById(item.id)">修改笔记</el-button>
                  <el-button type="primary" icon="el-icon-delete" plain @click="delete_noteById(item.id)">添加商品</el-button>
