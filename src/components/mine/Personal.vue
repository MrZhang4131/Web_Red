  ...
  methods: {
    changeShow (type_str) {
      ...
      if ("点赞" == type_str) {
        ...
        this.$http({
          url: 'https://localhost:8002/UserInfo/praise?userid='+window.sessionStorage.getItem("id"),
          method: 'get'
        }).then(res => {
        ...
        this.$http({
          url: 'https://localhost:8002/UserInfo/collection?userid='+window.sessionStorage.getItem("id"),
          method: 'get'
        }).then(res => {
            this.show_data = res.data
        }).catch(res => {
    ...
    get_userimfo () {
      this.$http({
        url: 'https://localhost:8002/UserInfo?userid='+window.sessionStorage.getItem("id"),
        method: 'get'
      }).then(res => {
          this.imfo = res.data
    ...
    upload(param) {
            ...
            const url = 'https://localhost:8002/Login/UploadImage'
            const headers = {
            ...
            this.$http.post(
                ...
                this.alter_imfo.headphoto = res.data
            }).catch(response => {
    ...
    openDrawer () {
      ...
      this.alter_imfo.id = this.imfo.id
      console.log(this.alter_imfo.id)
      this.drawer = true
    },
    ...
    rebate_to_money () {
      this.$http({
        url: 'https://localhost:8002/UserInfo/Payouts?userid='+window.sessionStorage.getItem("id"),
        method: 'put'
      }).then(res => {
    ...
    send_alter () {
      this.$http({
        url: 'https://localhost:8002/UserInfo/update',
        method: 'put',
