      ...
      <div class="dialog_conten">
        ...
        <div class="dialog_conten_imfo">
           ...
           <div class="two_imfo">
              ...
              <div>
                <!-- 使用v-for遍历渲染评论 -->
                <div v-for="(item,index) in targetData.goodsComment" :key="index" >
...
export default {
  ...
  methods: {
    ...
    // 获取首页数据
     getData() {
       this.$http({
         url: 'https://localhost:8002/Shopping',
         method: 'get'
       }).then(res => {
          //  console.log(res)
    ...
    openInfo (id) {
      // console.log(id)
      this.$http({
        url: 'https://localhost:8002/Shopping/content?id='+id,
        method: 'get'
      }).then(res => {
          console.log(res)
          this.targetData = res.data
          console.log(this.targetData.goods.picture)
      }).catch(res => {
        console.log(res);
      })
    ...
    children_search_note (search_text) {
      ...
      this.$http({
        url: 'https://localhost:8002/Shopping/search?param='+search_text,
        method: 'get',
      }).then(res => {
    ...
    addShoppingCart () {
      console.log("调用成功")
      this.$http({
        url: 'https://localhost:8002/ShoppingCar/add',
        method: 'post',
        data: {
          goodsId: this.targetData.goods.id,
