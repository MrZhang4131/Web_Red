  ...
  export default {
    ...
    methods: {
      ...
      upload_PictureNode_pictureurl(param) {
            ...
            const url = 'https://localhost:8002/Release/uploadPicture'
            const headers = {
        ...
        upload_PictureNode_surfacePicture (param) {
          const formdate = new FormData()
            ...
            this.$http.post(
                ...
                this.pictureNode.surfacePicture = res.data
        ...
        publish_PictureNode () {
          ...
          this.pictureNode.userid=window.sessionStorage.getItem("id");
          this.$http({
            url: 'https://localhost:8002/Release/picturenote',
      ...
      upload_VideoNode_surfacePicture (param) {
          const formdate = new FormData()
            ...
            this.$http.post(
                ...
                this.videoNote.surfacePicture = res.data
            }).catch(response => {
                console.log(response)
            })
        },
        ...
        upload_VideoNode_videurl (param) {
          const formdate = new FormData()
            ...
            const url = 'https://localhost:8002/Release/UploadVideo'
            const headers = {
                'Content-Type': 'multipart/form-data'
            }
            // axios.post的构造函数有顺序，不可乱
            this.$http.post(
                ...
                this.videoNote.videourl = res.data
                // console.log(this.videoNote)
            }).catch(response => {
                console.log(response)
            })
        ...
        publish_videoNode () {
          ...
          this.videoNote.userid=window.sessionStorage.getItem("id");
          this.$http({
            url: 'https://localhost:8002/Release/note',
            data: this.videoNote,
            method: 'post'
          }).then(res => {
