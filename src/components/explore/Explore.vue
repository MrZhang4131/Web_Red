<template>
  <div>
    ...
    <!-- 核心内容 -->
    <div class="waterful">
       <div class="watch_item"  v-for="(item,index) in show_data" :key="index">
      ...
      <div class="dialog_conten">
        ...
        <div class="dialog_conten_imfo">
           ...
           <div class="one_imfo">
             ...
             <!-- 返利促销 -->
             <div style="margin-left: 10px; float: right;" v-if="!(targetData.rebateid==0)">
              <el-popover
                placement="top-start"
                title="返利广告"
                width="200"
           ...
           <div class="two_imfo">
              ...
              <div>
                <!-- 使用v-for遍历渲染评论 -->
                <div v-for="(item,index) in targetData.comment" :key="index" >
    ...
    <el-drawer
      ...
      <h3 style="text-align: center">此页购买的商品，博主也可获得推广返利收益</h3>
        ...
        <div>
           <!-- 使用v-for遍历渲染评论 -->
           <div v-for="(item,index) in rebate_goods.goodsComment" :key="index">
             <div style="color: #303133;font-size: 15px;font-weight: 800;">
...
export default {
  ...
  methods: {
    ...
    // 获取首页数据
     getData() {
       this.$http({
         url: 'https://localhost:8002/Found',
         method: 'get'
       }).then(res => {
          //  console.log(res)
           this.data = res.data
           console.log(res.data)
           this.show_data = this.data.suggest
           console.log(this.show_data)
           console.log(this.show_data[0].note.surfacePicture)
       }).catch(res => {
         console.log(res);
       })
    },
    ...
    openInfo (id) {
      ...
      this.$http({
        url: 'https://localhost:8002/Found/content?id='+id,
        method: 'get'
      }).then(res => {
          // console.log(res)
    ...
    children_search_note (search_text) {
      ...
      this.$http({
        url: 'https://localhost:8002/Found/search',
        method: 'get',
        params: {
          param: search_text
        }
    ...
    change_zan () {
      ...
      this.$http({
        url: 'https://localhost:8002/Found/praise',
        method: 'post',
        params: {
          //键值对
    ...
    change_star () {
      ...
      this.$http({
         url: 'https://localhost:8002/Found/collection',
        method: 'post',
        params: {
          //键值对
          userid: window.sessionStorage.getItem('id'),
    ...
    sendComment () {
      this.$http({
        url: 'https://localhost:8002/Found/comment',
        method: 'post',
        params: {
          //键值对
        ...
        if ("保存成功" == res.data) {
          this.openInfo(this.data.noteid)
          this.comment_text = ''
        }
      }).catch(res => {
        console.log(res);
